        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mb-4">
              <Badge variant="outline" className="border-primary/30 bg-primary/10 text-xs sm:text-sm">
                Professional Summary
              </Badge>
              <Badge variant="outline" className="border-accent/30 bg-accent/10 text-xs sm:text-sm">
                📍 Available for Projects
              </Badge>
            </div>
            
            <h3 className="text-xl sm:text-2xl font-bold mb-3 gradient-text break-words">
          ...
          <div className="flex flex-col gap-3 w-full lg:w-auto">
            <Button 
              className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 btn-hover-lift w-full lg:w-auto"
              asChild
            >
